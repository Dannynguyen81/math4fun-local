...
- UI language: Vietnamese. Design movement: Field Journal Quest / contemporary editorial field guide.
- Asset use is local prototype only; guardians use existing local prototype artwork URLs.
- Current source baseline was 10 verified questions from Tập 1 PDF pages 38–39.
