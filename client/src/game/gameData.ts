...
export const SHOP_ITEMS: ShopItem[] = [
  { id: "potion-25", label: "Bình Lộ Sáng 25%", heal: 25, price: 35, description: "Hồi 25 HP cho một guardian đang sở hữu.", tone: "bg-[#e4f3fb] border-[#55a9dd]" },
  ...
  { id: "potion-100", label: "Bình Lộ Sáng 100%", heal: 100, price: 110, description: "Hồi đầy 100 HP cho một guardian đang sở hữu.", tone: "bg-[#fff0b6] border-[#f6b73c]" },
];
