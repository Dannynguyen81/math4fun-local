...
export const STATIONS: Station[] = [
  ...
  { id: 12, code: "T1.08", title: "Nhân & chia", brief: "Củng cố quy tắc tính, tính chất phép toán và tìm ẩn số.", group: "Số và phép tính", book: "Tập 1", guardianId: "dexo", accent: "bg-amber-500", questionIds: ["T1-NC-136a", "T1-NC-136b", "T1-NC-136c", "T1-NC-136d", "T1-NC-137g", "T1-NC-138a", "T1-NC-138b", "T1-NC-138d", "T1-NC-140-first", "T1-NC-141-first"], masteryTarget: 10, status: "ready" },
