...
/** Field Journal Quest: trả lại bộ hình pet cũ theo phản hồi người chơi.
 * Chỉ thay phần minh họa; ID pet mới, tiến độ, trạm, phép và dữ liệu đã lưu vẫn giữ nguyên. */
const legacyPetSprite = (id: number) => `https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/official-artwork/${id}.png`;
export const LEGACY_PET_SPRITES = {
  cubix: legacyPetSprite(172),
  vane: legacyPetSprite(298),
  scalera: legacyPetSprite(403),
  voltaria: legacyPetSprite(387),
  mossar: legacyPetSprite(447),
  coris: legacyPetSprite(280),
  aerion: legacyPetSprite(66),
  brio: legacyPetSprite(175),
  lumen: legacyPetSprite(183),
  noris: legacyPetSprite(234),
  pavor: legacyPetSprite(37),
  solaris: legacyPetSprite(25),
  dexia: legacyPetSprite(158),
  marion: legacyPetSprite(133),
  senia: legacyPetSprite(152),
  koran: legacyPetSprite(23),
  vexan: legacyPetSprite(52),
  runon: legacyPetSprite(54),
  tavira: legacyPetSprite(135),
  nexia: legacyPetSprite(196),
  atlasPrime: legacyPetSprite(143),
  myrion: legacyPetSprite(150),
} as const;

export const GUARDIANS: Guardian[] = [
  { id: "cubix", name: "Cubix", type: "GEOMETRY / EARTH", element: "đất", description: "Pet hình khối đất nung nguyên bản, giúp tính chu vi và thể tích hình khối 3D.", stationId: 1, sprite: LEGACY_PET_SPRITES.cubix, tone: "bg-amber-600" },
  { id: "vane", name: "Vane", type: "WIND / ANGLE", element: "gió", description: "Pet chong chóng gió nguyên bản, đo đạc góc độ và khoảng cách trên bản đồ.", stationId: 2, sprite: LEGACY_PET_SPRITES.vane, tone: "bg-teal-500" },
  { id: "scalera", name: "Scalera", type: "WATER / SCALE", element: "nước", description: "Pet giọt nước tỷ lệ nguyên bản, quy đổi đơn vị đo lường chính xác.", stationId: 3, sprite: LEGACY_PET_SPRITES.scalera, tone: "bg-sky-500" },
  { id: "voltaria", name: "Voltaria", type: "UNIT / SPARK", element: "sấm", description: "Pet lăng kính sấm sét nguyên bản, phân chia đơn vị tính toán.", stationId: 4, sprite: LEGACY_PET_SPRITES.voltaria, tone: "bg-amber-400" },
  { id: "mossar", name: "Mossar", type: "DIFFERENCE / TRAIL", element: "đất", description: "Pet mầm rêu cổ đại, cân bằng bài toán tổng hiệu.", stationId: 5, sprite: LEGACY_PET_SPRITES.mossar, tone: "bg-lime-600" },
  { id: "coris", name: "Coris", type: "FRACTION / CRYSTAL", element: "lửa", description: "Pet tinh thể phân đoạn rực lửa, chia đều các phần.", stationId: 6, sprite: LEGACY_PET_SPRITES.coris, tone: "bg-rose-500" },
  { id: "aerion", name: "Aerion", type: "AREA / FIELD", element: "gió", description: "Pet lưới gió không gian, đo đạc diện tích ô lưới.", stationId: 7, sprite: LEGACY_PET_SPRITES.aerion, tone: "bg-cyan-600" },
  { id: "brio", name: "Brio", type: "MASS / CRAFT", element: "đất", description: "Pet khối trọng lượng đất nung, quy đổi khối lượng.", stationId: 8, sprite: LEGACY_PET_SPRITES.brio, tone: "bg-orange-600" },
  { id: "lumen", name: "Lumen", type: "TIME / LANTERN", element: "lửa", description: "Pet đèn lồng thời gian, giữ nhịp độ hành trình.", stationId: 9, sprite: LEGACY_PET_SPRITES.lumen, tone: "bg-yellow-500" },
  { id: "noris", name: "Noris", type: "GRAPH / TIDE", element: "nước", description: "Pet dòng chảy biểu đồ, đọc số liệu trực quan.", stationId: 10, sprite: LEGACY_PET_SPRITES.noris, tone: "bg-blue-600" },
  { id: "pavor", name: "Pavor", type: "PERIMETER / MARK", element: "độc", description: "Pet huy hiệu chu vi tím, định hình ranh giới hình học.", stationId: 11, sprite: LEGACY_PET_SPRITES.pavor, tone: "bg-violet-600" },
  { id: "solaris", name: "Solaris", type: "REVERSE / FLAME", element: "lửa", description: "Pet ngọn lửa ngược, tìm lại số ban đầu.", stationId: 12, sprite: LEGACY_PET_SPRITES.solaris, tone: "bg-red-600" },
  { id: "dexia", name: "Dexia", type: "MULTIPLY / SPARK", element: "sấm", description: "Pet tia chớp nhân chia, tính toán tốc độ cao.", stationId: 13, sprite: LEGACY_PET_SPRITES.dexia, tone: "bg-amber-500" },
  { id: "marion", name: "Marion", type: "DIVIDE / TIDE", element: "nước", description: "Pet bánh xe nước chia đều, giải bài toán phân phối.", stationId: 14, sprite: LEGACY_PET_SPRITES.marion, tone: "bg-teal-600" },
  { id: "senia", name: "Senia", type: "DECIMAL / MIST", element: "gió", description: "Pet sương mù số thập phân, định vị chính xác.", stationId: 15, sprite: LEGACY_PET_SPRITES.senia, tone: "bg-slate-600" },
  { id: "koran", name: "Koran", type: "COMPOSITE / LEAF", element: "đất", description: "Pet lá ghép diện tích đa giác phức hợp.", stationId: 16, sprite: LEGACY_PET_SPRITES.koran, tone: "bg-green-600" },
  { id: "vexan", name: "Vexan", type: "RATIO / VENOM", element: "độc", description: "Pet tỷ lệ độc lập, so sánh hơn kém rõ ràng.", stationId: 17, sprite: LEGACY_PET_SPRITES.vexan, tone: "bg-fuchsia-600" },
  { id: "runon", name: "Runon", type: "MONEY / COIN", element: "lửa", description: "Pet đồng tiền niêm phong, tính toán mua sắm.", stationId: 18, sprite: LEGACY_PET_SPRITES.runon, tone: "bg-orange-500" },
  { id: "tavira", name: "Tavira", type: "DATA / NOTE", element: "nước", description: "Pet bảng số liệu gọn gàng, tổng hợp dữ liệu.", stationId: 19, sprite: LEGACY_PET_SPRITES.tavira, tone: "bg-indigo-500" },
  { id: "nexia", name: "Nexia", type: "MIXED / ARCHIVE", element: "gió", description: "Pet lưu trữ tổng hợp cuối tuyến học tập.", stationId: 20, sprite: LEGACY_PET_SPRITES.nexia, tone: "bg-indigo-700" },
  { id: "atlas-prime", name: "Atlas Prime", type: "BOSS / ARCHIVE", element: "độc", description: "Thủ lĩnh kho lưu trữ nguyên bản, phản công sắc bén ở mọi lượt.", stationId: "boss", sprite: LEGACY_PET_SPRITES.atlasPrime, tone: "bg-slate-900" },
];

export const MAP_BOSS_ARCHIVES: Record<MapId, MapBossArchive> = {
  1: { mapId: 1, name: "Atlas", title: "Người Giữ Kho Mực Chàm", element: "độc", sprite: LEGACY_PET_SPRITES.atlasPrime, note: "Atlas phản công ở mỗi lượt của trận tổng hợp Tập 1.", badge: "Dũng sĩ diệt Boss cấp 1", reward: "Mở Map 2 · Nhật ký La Bàn Vàng" },
  2: { mapId: 2, name: "Myrion", title: "Người Gác La Bàn Vàng", element: "sấm", sprite: LEGACY_PET_SPRITES.myrion, note: "Myrion là cửa khảo nghiệm cuối, tổng hợp các dấu vết từ Tập 2.", badge: "Dũng sĩ diệt Boss cấp 2", reward: "Ghi danh hoàn tất hành trình Toán 4" },
};
